# A17 JS Helpers - Demos/Documentation

The documentation is made using [Jekyll](https://jekyllrb.com/) to compile [Liquid](https://shopify.github.io/liquid/) templates. 

To view these in a browser, visit [area17.github.io/tailwind-plugins/](https://area17.github.io/js-helpers/).
...
Currently the built CSS and JS for this demos is pre-built using the CSS from our [Tailwind Plugin docs](https://area17.github.io/tailwind-plugins/) and the JS from [https://code.area17.com/antoine/behaviors-state-management/-/tree/main](https://code.area17.com/antoine/behaviors-state-management/). **If you need to add more demos/docs - you'll need to add a build step etc.**
